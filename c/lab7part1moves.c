	...
	for (int row = 0; row < boardSize; row++) {
		for (int col = 0; col < boardSize; col++) {
			...
			if (gameBoard[row][col] == 'U') {
				if (scoreInDirection(boardSize, row, col, -1, -1, player, gameBoard)) playerMoves[row][col] += scoreInDirection(boardSize, row, col, -1, -1, player, gameBoard);
				if (scoreInDirection(boardSize, row, col, -1, 0, player, gameBoard))  playerMoves[row][col] += scoreInDirection(boardSize, row, col, -1, 0, player, gameBoard);
				if (scoreInDirection(boardSize, row, col, -1, 1, player, gameBoard))  playerMoves[row][col] += scoreInDirection(boardSize, row, col, -1, 1, player, gameBoard);
				if (scoreInDirection(boardSize, row, col, 0, -1, player, gameBoard))  playerMoves[row][col] += scoreInDirection(boardSize, row, col, 0, -1, player, gameBoard);
				if (scoreInDirection(boardSize, row, col, 0, 1, player, gameBoard))   playerMoves[row][col] += scoreInDirection(boardSize, row, col, 0, 1, player, gameBoard);
				if (scoreInDirection(boardSize, row, col, 1, -1, player, gameBoard))  playerMoves[row][col] += scoreInDirection(boardSize, row, col, 1, -1, player, gameBoard);
				if (scoreInDirection(boardSize, row, col, 1, 0, player, gameBoard))   playerMoves[row][col] += scoreInDirection(boardSize, row, col, 1, 0, player, gameBoard);
				if (scoreInDirection(boardSize, row, col, 1, 1, player, gameBoard))   playerMoves[row][col] += scoreInDirection(boardSize, row, col, 1, 1, player, gameBoard);
